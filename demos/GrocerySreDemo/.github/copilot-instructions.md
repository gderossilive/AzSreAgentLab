# Copilot Instructions — GrocerySreDemo

## Project Constitution (committed)
This file is the **stable, repo-wide constitution**: rules that always apply.

- Purpose: Grocery SRE demo — supplier rate-limit incident (429 errors) on Azure Container Apps, with Grafana MCP tooling and Azure SRE Agent autonomous investigation.
