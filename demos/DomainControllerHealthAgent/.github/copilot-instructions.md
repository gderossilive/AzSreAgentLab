# Copilot Instructions — DomainControllerHealthAgent

## Project Constitution (committed)
This file is the **stable, repo-wide constitution**: rules that always apply.

- Purpose: Domain Controller health monitoring demo — Azure SRE Agent subagent for periodic DC health checks.
