...
Reusable demo skills live under [.github/skills/](.github/skills/).

- Trigger Octopets incident for Demo3 / ServiceNow flow: [.github/skills/octopets-incident-trigger/SKILL.md](.github/skills/octopets-incident-trigger/SKILL.md)
- Trigger Grocery supplier throttling for Demo2: [.github/skills/grocery-api-throttling/SKILL.md](.github/skills/grocery-api-throttling/SKILL.md)
